...
CREATE TABLE IF NOT EXISTS ElencoFilme (
  ...
  PRIMARY KEY (`Id`),
  CONSTRAINT `FK_ElencoFilme_IdAtor` FOREIGN KEY (`IdAtor`) REFERENCES Atores (`Id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS FilmesGenero (
  ...
  `IdFilme` INT DEFAULT NULL,
  PRIMARY KEY (`Id`),
  CONSTRAINT `FK_FilmesGenero_IdFilme` FOREIGN KEY (`IdFilme`) REFERENCES Filmes (`Id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
